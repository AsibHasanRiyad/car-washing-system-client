const Hero = () => {
  return (
    <div>
      ...
      <div className="relative pt-4 overflow-hidden bg-neutral-900">
        <svg
        ...
        <div className="relative z-10">
          <div className="max-w-5xl px-4 mx-auto xl:px-0">
            ...
            <div className="flex items-center justify-between gap-6 pb-5">
              <img
                className="w-20 h-20 "
                src="https://i.ibb.co.com/tsVLZGN/bmw.png"
                alt=""
              />
              <img
                className="w-24 h-24 "
                src="https://i.ibb.co.com/GFxGj62/audi.png"
                alt=""
              />
              <img
                className="w-20 h-20 "
                src="https://i.ibb.co.com/Yj9Nfnb/nissan.png"
                alt=""
              />
              <img
                className="w-20 h-20 "
                src="https://i.ibb.co.com/Db6gXTt/car3.png"
                alt=""
              />
            </div>
          </div>
