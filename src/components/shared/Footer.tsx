    ...
    <div className="relative w-full p-10 bg-[#171717]">
      ...
      <div className="relative flex flex-col w-full px-4 text-white ">
        ...
        <div className="flex flex-col mt-8 md:flex-row md:justify-between">
          <p className="w-full text-neutral-400 md:w-2/3">
            At CleanCarCo, we believe that a clean car is more than just a
            vehicle—it’s a reflection of your style, your personality, and your
            pride. Located in the heart of the community, we’re committed to
            delivering exceptional car wash services with a focus on quality,
