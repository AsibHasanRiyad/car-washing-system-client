...
const ServiceCard = ({ service }: { service: TService }) => {
  ...
  return (
    <Link to={`/service-details/${service._id}`}>
      <div className="relative rounded-md space-y-8 bg-white hover:scale-105 transition-all transform duration-200 p-8 shadow-[0px_0px_30px_2px_rgba(100,100,111,0.1)] md:w-full lg:w-[300px]">
        {/* Top Part */}
        <div>
          {/* Price Ribbon SVG */}
